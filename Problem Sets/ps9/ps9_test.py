...
##    assert type(subInfo1) == tuple, "Arguments to comparator should be tuples"
##    print sum(subInfo1)
    return course.getValue() + course.getWork()
...
def test_greedyAdvisor():
    ...
    actual = ps9.greedyAdvisor(smallCatalog.copy(), 15, ps9.keyWork)
    if expected != actual:
        failed = True
    ...
    actual = ps9.greedyAdvisor(smallCatalog.copy(), 15, ps9.keyRatio)
    if expected != actual:
        failed = True
